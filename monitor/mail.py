...
class Mail(object):
 ...
 <body><span style='cursor=hand'><B>HTML文本</B></span></html>
  '''
 def __init__(self, host='mail.oracle.com', port='25', user='', psd='', mailFrom='dbmonitor@oracle.com.cn', mailTo=['test@oracle.com.cn']):
 ...
 def sendMsg(self, subject, msg, attachment_file=None, _login='false'):
  ...
  msgRoot['From'] = '数据库服务监控<' + self.fromAdd + '>'
  msgRoot['To'] = mailto
  ...
  try:
   ...
   #print '发送邮件异常:'.decode('utf-8').encode('gb2312')+str(e)
   return
  return
